...
class Delivery implements ModelInterface, ArrayAccess
{
    ...
    {
        if (!is_null($additional_info) && (mb_strlen($additional_info) > 500)) {
            throw new \InvalidArgumentException('invalid length for $additional_info when calling Delivery., must be smaller than or equal to 500.');
        }

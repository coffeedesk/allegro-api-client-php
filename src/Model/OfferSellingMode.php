 ...
 *
 * @category Class
 * @description This section indicates selling format and prices.
 * @package  AllegroApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class OfferSellingMode implements ModelInterface, ArrayAccess
{
     ...
     * Sets format
     *
     * @param string|null $format *BUY_NOW*, *AUCTION* or *ADVERTISEMENT*
     *
     * @return $this
     */
     ...
     * Sets popularity
     *
     * @param int|null $popularity Popularity of item for *BUY_NOW* selling format.
     *
     * @return $this
     */

 ...
 *
 * @category Class
 * @description Information about promotion options of the item.
 * @package  AllegroApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class OfferPromotion implements ModelInterface, ArrayAccess
{
     ...
     * Sets emphasized
     *
     * @param bool|null $emphasized Indicates whether the item is promoted.
     *
     * @return $this
     */
     ...
     * Sets bold
     *
     * @param bool|null $bold Indicates whether the item has bold title option.
     *
     * @return $this
     */
     ...
     * Sets highlight
     *
     * @param bool|null $highlight Indicates whether the item has highlight option.
     *
     * @return $this
     */

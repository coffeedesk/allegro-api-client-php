 ...
 *
 * @category Class
 * @description Information about available shipping options for the item.
 * @package  AllegroApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class OfferDelivery implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param bool|null $available_for_free Indicates whether the item has free shipping option.
     *
     * @return $this
     */

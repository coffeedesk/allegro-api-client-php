...
class AdditionalServicesApi
{
     ...
     */
    public function getListOfAdditionalServicesGroupsUsingGET($user_id, $offset = 0, $limit = 1000)
    {
     ...
     */
    public function getListOfAdditionalServicesGroupsUsingGETWithHttpInfo($user_id, $offset = 0, $limit = 1000)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getListOfAdditionalServicesGroupsUsingGETAsync($user_id, $offset = 0, $limit = 1000)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getListOfAdditionalServicesGroupsUsingGETAsyncWithHttpInfo($user_id, $offset = 0, $limit = 1000)
    {
        $returnType = '\AllegroApi\Model\AdditionalServicesGroups';
        $request = $this->getListOfAdditionalServicesGroupsUsingGETRequest($user_id, $offset, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getListOfAdditionalServicesGroupsUsingGETRequest($user_id, $offset = 0, $limit = 1000)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(

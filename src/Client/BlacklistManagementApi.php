...
class BlacklistManagementApi
{
     ...
     */
    public function doGetBlackListUsers()
    {
        list($response) = $this->doGetBlackListUsersWithHttpInfo();
        return $response;
    }
     ...
     */
    public function doGetBlackListUsersWithHttpInfo()
    {
        $request = $this->doGetBlackListUsersRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doGetBlackListUsersAsync()
    {
        return $this->doGetBlackListUsersAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doGetBlackListUsersAsyncWithHttpInfo()
    {
        $returnType = '\AllegroApi\Model\BlackListPagedResponse';
        $request = $this->doGetBlackListUsersRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function doGetBlackListUsersRequest()
    {

...
class ProductsApi
{
     ...
     */
    public function getSaleProducts($ean = null, $phrase = null, $category_id = null, $a_filters_id = null, $page_id = null)
    {
        list($response) = $this->getSaleProductsWithHttpInfo($ean, $phrase, $category_id, $a_filters_id, $page_id);
        return $response;
    }
     ...
     */
    public function getSaleProductsWithHttpInfo($ean = null, $phrase = null, $category_id = null, $a_filters_id = null, $page_id = null)
    {
        $request = $this->getSaleProductsRequest($ean, $phrase, $category_id, $a_filters_id, $page_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSaleProductsAsync($ean = null, $phrase = null, $category_id = null, $a_filters_id = null, $page_id = null)
    {
        return $this->getSaleProductsAsyncWithHttpInfo($ean, $phrase, $category_id, $a_filters_id, $page_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSaleProductsAsyncWithHttpInfo($ean = null, $phrase = null, $category_id = null, $a_filters_id = null, $page_id = null)
    {
        $returnType = '\AllegroApi\Model\GetSaleProductsResponse';
        $request = $this->getSaleProductsRequest($ean, $phrase, $category_id, $a_filters_id, $page_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSaleProductsRequest($ean = null, $phrase = null, $category_id = null, $a_filters_id = null, $page_id = null)
    {
        ...
        // query params
        if ($page_id !== null) {
            $queryParams['page.id'] = ObjectSerializer::toQueryValue($page_id);
        }

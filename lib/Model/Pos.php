...
class Pos implements ModelInterface, ArrayAccess
{
     ...
     * Sets created_at
     *
     * @param string|null $created_at Creation date. Date format (ISO 8601) - yyyy-MM-dd'T'HH:mm:ss.SSSZ
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at Modification date. Date format (ISO 8601) - yyyy-MM-dd'T'HH:mm:ss.SSSZ
     *
     * @return $this
     */

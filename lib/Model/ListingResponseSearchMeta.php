...
class ListingResponseSearchMeta implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int|null $available_count Number of results available for navigation. If this number is less than the total count, search criteria (categories, filters) should be narrowed down to make all results available.
     *
     * @return $this
     */
     ...
     * Sets total_count
     *
     * @param int|null $total_count Total number of search results for given parameters.
     *
     * @return $this
     */
     ...
     * Sets fallback
     *
     * @param bool|null $fallback Indicates whether search fallback was used. If true, no items matching exact given phrase were found and related items are presented.
     *
     * @return $this
     */

...
class ListingResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets filters
     *
     * @param \OpenAPI\Client\Model\ListingResponseFilters[]|null $filters Filters with counters available for given search, which can be used to refine search results.
     *
     * @return $this
     */

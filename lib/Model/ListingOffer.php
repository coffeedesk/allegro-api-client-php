...
class ListingOffer implements ModelInterface, ArrayAccess
{
     ...
     * Sets id
     *
     * @param string|null $id Identifier of the item.
     *
     * @return $this
     */
     ...
     * Sets images
     *
     * @param \OpenAPI\Client\Model\OfferImages[]|null $images Gallery of images. Only URL of original size image is provided. First image should be considered as a thumbnail on listing.
     *
     * @return $this
     */
